    ...
    <>
      ...
      <nav className="sticky top-0 z-50 bg-bg-dark/80 backdrop-blur-2xl border-b border-white/5 transition-all duration-500">
        <div className="max-w-7xl mx-auto px-6 lg:px-12 h-20 flex items-center justify-between">
              <div className="flex items-center gap-4 group cursor-pointer" onClick={(e) => { playClick(); scrollTo("root", e); }}>
                <div className="relative">
                  <motion.img 
                    ...
                    className="w-10 h-10 rounded-xl relative z-10 border border-white/10 shadow-lg"
                  />
                  <div className="absolute inset-0 bg-brand-cyan/5 blur-xl rounded-full scale-0 group-hover:scale-150 transition-transform duration-700" />
                </div>
          ...
          <div className="hidden lg:flex items-center gap-10">
            <div className="flex items-center gap-8 text-[11px] font-semibold uppercase tracking-widest text-slate-400">
              <a href="#" onClick={(e) => { playClick(); scrollTo("root", e); }} className="hover:text-brand-cyan transition-colors relative group/link">
                Home
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-brand-cyan transition-all duration-300 group-hover/link:w-full" />
              </a>
              <a href="#features" onClick={(e) => { playClick(); scrollTo("features", e); }} className="hover:text-brand-cyan transition-colors relative group/link">
                Features
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-brand-cyan transition-all duration-300 group-hover/link:w-full" />
              </a>
              <a href="#games" onClick={(e) => { playClick(); scrollTo("games", e); }} className="hover:text-brand-cyan transition-colors relative group/link">
                Fleet
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-brand-cyan transition-all duration-300 group-hover/link:w-full" />
              </a>
              <a href="#pricing" onClick={(e) => { playClick(); scrollTo("pricing", e); }} className="hover:text-brand-cyan transition-colors relative group/link">
                Nodes
                <span className="absolute -bottom-1 left-0 w-0 h-px bg-brand-cyan transition-all duration-300 group-hover/link:w-full" />
              </a>
            </div>
            ...
            <button 
              ...
              className="flex items-center gap-2 group text-[11px] font-semibold uppercase tracking-widest text-slate-500 hover:text-brand-cyan transition-colors"
            >
